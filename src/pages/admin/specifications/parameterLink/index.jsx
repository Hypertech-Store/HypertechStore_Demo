    ...
    <div className="content">
        ...
        <div className="modal-dialog modal-l modal-dialog-centered">
          <div className="modal-content bg-body-highlight p-6">
            <div className="modal-header justify-content-between border-0 p-0 mb-2">
              <h3 className="mb-0">Add parameter link</h3>
              <button
                ...
                <div className="col-lg-12">
                  <div className="mb-2">
                    ...
                    <select className="form-control">
                      ...
                      <option value="spec1">Thông số 1</option>
                      <option value="spec2">Thông số 2</option>
                    </select>
                  </div>
                </div>
      ...
      >
        <div className="modal-dialog modal-l modal-dialog-centered">
          <div className="modal-content bg-body-highlight p-6">
            <div className="modal-header justify-content-between border-0 p-0 mb-2">
              <h3 className="mb-0">Edit parameter link</h3>
              <button
                className="btn btn-sm btn-phoenix-secondary"
                data-bs-dismiss="modal"
                aria-label="Close"
